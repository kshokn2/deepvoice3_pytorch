...
from deepvoice3_pytorch.frontend.ko import cleaners
from deepvoice3_pytorch.frontend.ko.symbols import symbols, en_symbols, PAD, EOS
from deepvoice3_pytorch.frontend.ko.korean import jamo_to_korean
...
def text_to_sequence(text, as_token=False):
    return _text_to_sequence(text, ['korean_cleaners'], as_token)
...
def sequence_to_text(sequence, skip_eos_and_pad=False, combine_jamo=False):
    ...
    cleaner_names=['korean_cleaners'] #[x.strip() for x in hparams.cleaners.split(',')]
